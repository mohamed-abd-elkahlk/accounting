...
const ToastIcon = ({
  ...
  switch (variant) {
    ...
    case "destructive":
      return <AlertCircle className="h-10 w-10 text-white" />; // Adjusted to text-red-500
    default:
      return null;
  }
};
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-500 group-[.destructive]:hover:text-red-700 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600", // Updated text-red-500 and hover-text-red-700 for visibility
      className
    )}
    toast-close=""
    {...props}
